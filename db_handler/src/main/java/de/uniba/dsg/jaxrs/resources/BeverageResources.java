...
public class BeverageResources{
	...
	public Response getBeverages(@Context final UriInfo info) {
		System.out.println("Get Beverages from DB");
		logger.info("Get all beverages");
		final GenericEntity<List<BottleDTO>> entity = new GenericEntity<List<BottleDTO>>(
				BottleDTO.marshall(BeverageServices.instance.getBeverages(), info.getBaseUri())
		){
		};

...
set CLASSPATH=%APP_HOME%\lib\db_handler-all.jar

@rem Execute db_handler
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %DB_HANDLER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%DB_HANDLER_EXIT_CONSOLE%" exit 1
exit /b 1

...
import de.uniba.dsg.jaxrs.resources.BeverageManagementResources;
...
public class BottleDTO{
	...
	public BottleDTO(final Bottle b, final URI baseUri) {
		...
		this.supplier = b.getSupplier();
		this.inStock = b.getInStock();
		this.href = UriBuilder.fromUri(baseUri).path(BeverageManagementResources.class).path(BeverageManagementResources.class, "getBeverage")
		      .build(this.id);
	}
